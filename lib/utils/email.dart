...
class Email{
   Future<dynamic> sendEmail(String bodyEmail, String sender, String recipient, String subject, {List<Attachment> attachment}) async{

     DocumentSnapshot emailConfig = await getEmailSettings();

     var options = new GmailSmtpOptions()
      ..username = emailConfig.data["username"]
      ..password = emailConfig.data["passGmail"]; 
  ...
  Future<DocumentSnapshot> getEmailSettings() async{
    return await Firestore.instance.collection("config").document("generalConfig").get();
  }


  Future<void> saveAndSendEmailToAcademy(String academyId, BuildContext context) async {
    try {
      ...
      await new Email().sendEmail("QR-CODE", "murilo08inter@gmail.com",
